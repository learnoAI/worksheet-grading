...
export function UserForm({ 
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.role === UserRole.STUDENT && formData.tokenNumber) {
        userData.tokenNumber = formData.tokenNumber;
      }

      if (formData.classId && (formData.role === UserRole.STUDENT || formData.role === UserRole.TEACHER)) {
        userData.classId = formData.classId;
      }

      if (formData.role === UserRole.ADMIN && formData.schoolId) {
      ...
      if (mode === 'create') {
        ...
        await userAPI.updateUser(initialData?.id!, userData);
