    ...
    useEffect(() => {
        if (worksheet.gradingDetails) {
            console.log(`[WrongQuestions] ${worksheet.name}:`, {
                hasGradingDetails: !!worksheet.gradingDetails,
                wrongQuestions: worksheet.gradingDetails.wrong_questions?.length || 0,
                unansweredQuestions: worksheet.gradingDetails.unanswered_questions?.length || 0,
                wrongQuestionNumbers: worksheet.wrongQuestionNumbers,
                autoGenerated: getWrongQuestionNumbersFromGrading(),
                displayed: displayedWrongQuestionNumbers
            });
        }
    }, [worksheet.gradingDetails, worksheet.wrongQuestionNumbers, worksheet.name]);
