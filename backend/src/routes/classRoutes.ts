...
// Get a teacher's classes with per-class block reasons (for reassign UI)
router.get('/by-teacher/:teacherId', asHandler(getClassesByTeacherWithStatus));
